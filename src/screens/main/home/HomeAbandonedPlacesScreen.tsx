...
interface HomeAbandonedPlacesProps {
  navigation: {
    openDrawer: Function
    navigate: Function
  }
...
const HomeAbandonedPlacesScreen: React.FC<HomeAbandonedPlacesProps> = ({
  navigation,
  route,
  ...props
}) => {
      ...
      <View style={styles.body}>
        <FlatList
          ...
          renderItem={({item}) => (
            <TouchableOpacity
              onPress={() => {
                // TASK 1. Reuse same Screen
                navigation.navigate('HomeAbandonedPlaceDetailsPage', {
                  item,
                })
              }}
            >
...
export {HomeAbandonedPlacesScreen}
